...
import 'package:habit_tracker/views/edit_habit_view.dart';
...
class HabitController extends ChangeNotifier {
  ...
  Widget buildHabitList(DateTime selectedDate, BuildContext context) {
      ...
      if (habits.isNotEmpty) {
        ...
        habitListWidgets.addAll(
          habits.map((habit) => HabitCard(
                ...
                onEdit: () async {
                  var updatedHabit = await showDialog<Habit>(
                    context: context,
